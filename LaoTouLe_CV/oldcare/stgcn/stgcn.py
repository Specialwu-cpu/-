...
from LaoTouLe_CV.oldcare.stgcn.Models import TwoStreamSpatialTemporalGraph
from LaoTouLe_CV.oldcare.stgcn.Utils import normalize_points_with_size, scale_pose
...
class STGCN(object):
    ...
    def __init__(self,
                 weight_file='LaoTouLe_CV/models/tsstg_model.pth',
                 device='cuda'):
        ...
        self.model.load_state_dict(torch.load(weight_file, map_location={'cuda:1': 'cuda:0'}))
        self.model.eval()
